                ...
                <ul class="filterbox">
                  <li v-for="(count , name) in allfilters[col]" :title="name">
                    <label :for="col + '_' + name">
                      <input
                        :checked="activefilters[col] && activefilters[col][name] && activefilters[col][name] == 'active'"
                        @change="editFilter($event, col, name)" type="checkbox" :id="col + '_' + name" name="filtertest"
                        value="">
                      {{name}}
                    </label>
                  </li>
